...
//import dao.KhachHang_DAO.KhachHangThongKe;
//import dao.LoaiPhong_DAO;
//import entity.DS_ThongKeKhachHang;
//import entity.KhachHang;
//import entity.ThongKeKhachHang;
//import gui.LineChartTest;
//import gui.PieChartKhachHangCP;
...
public class PnGiaoDienThongKeKhachHang extends JPanel implements ActionListener {
...
//	private LinkedHashMap<String, ThangNam> sortedMapMonth;
...
//			{ "Loại phòng", "Tất cả loại phòng", "Loại xài nhiều nhất", "Loại xài ít nhất" },
//			{ "Dịch vụ", "Tất cả dịch vụ", "DV xài nhiều nhất", "DV xài ít nhất" } };
...
//	}
//
//	class ThangNamComparator implements Comparator<Map.Entry<String, ThangNam>> {
//	    @Override
//	    public int compare(Map.Entry<String, ThangNam> entry1, Map.Entry<String, ThangNam> entry2) {
//	        ThangNam thangNam1 = entry1.getValue();
//	        ThangNam thangNam2 = entry2.getValue();
//
//	        // So sánh giảm dần dựa trên tháng và năm
//	        if (thangNam1.nam != thangNam2.nam) {
//	            return Integer.compare(thangNam1.nam, thangNam2.nam);
//	        } else {
//	            return Integer.compare(thangNam1.thang, thangNam2.thang);
//	        }
//	    }
//	}
//
...
//	 */
//	public PnGiaoDienThongKeKhachHang() {
...
//		}
//		
//		// Chuyển Map.Entry thành List để sắp xếp
//        List<Map.Entry<String, ThangNam>> entryList = new ArrayList<>(mapMonth.entrySet());
//
//        // Sắp xếp List theo giá trị giảm dần sử dụng Comparator
//        Collections.sort(entryList, new ThangNamComparator());
//
//        // Tạo một Map mới để lưu trữ kết quả sắp xếp
//        this.sortedMapMonth = new LinkedHashMap<>();
//
//        // Đưa các phần tử đã sắp xếp vào Map mới
//        for (Map.Entry<String, ThangNam> entry : entryList) {
//        	sortedMapMonth.put(entry.getKey(), entry.getValue());
//        }
//        
//     // In ra Map đã sắp xếp
////        for (Map.Entry<String, ThangNam> entry : sortedMapMonth.entrySet()) {
...
//				for (int i = 1; i <= 2; i++) {
//					for (int j = 0; j < listTieuChi[i].length; j++) {
//						String item = listTieuChi[i][j];
...
//		String tieuChi[] = { listTieuChi[0][0], listTieuChi[1][0], listTieuChi[2][0] };
...
//				}
//			} else if (cmbTieuChi.getSelectedItem().toString().equals(listTieuChi[1][0])) {
//				column.setHeaderValue(listTitle[1][0]);
//				columnChangeTitleDetail.setHeaderValue(listTitle[1][1]);
//				columnChangeTitle.setHeaderValue(listTieuChi[1][0]);
//				if (loaiDaChon.equals(listLoai[0][1])) {
...
//				}
//
//			} else if (cmbTieuChi.getSelectedItem().toString().equals(listTieuChi[2][0])) {
//				column.setHeaderValue(listTitle[2][0]);
//				columnChangeTitleDetail.setHeaderValue(listTitle[2][1]);
//				columnChangeTitle.setHeaderValue(listTieuChi[2][0]);
//				if (loaiDaChon.equals(listLoai[0][1])) {
//					datePickerDen.getComponent(1).setEnabled(false);
//				} else if (loaiDaChon.equals(listLoai[0][2])) {
//					cmbThangDen.setEnabled(false);
...
//			}
//
////			if (loaiDaChon.equals("Ngày")) {
////				datePickerDen.getComponent(1).setEnabled(true);
////				modelDenNgay.setValue(null);
////			} else if (loaiDaChon.equals("Tháng")) {
////				comboThangDen.setEnabled(true);
////			} else if (loaiDaChon.equals("Năm")) {
////				comboNamDen.setEnabled(true);
////			}
////			
...
//		modelTKChiTiet.addColumn("Số điện thoại"); // 5
//		modelTKChiTiet.addColumn("CCCD"); // 6
//		modelTKChiTiet.addColumn("Địa chỉ"); // 7
//
...
//		tblTKChiTiet.getColumnModel().getColumn(5).setPreferredWidth(110); // số điện thoại
//		tblTKChiTiet.getColumnModel().getColumn(6).setPreferredWidth(100); // CCCD
//		tblTKChiTiet.getColumnModel().getColumn(7).setPreferredWidth(300); // Địa chỉ
//
//		// sort
...
//			boolean flag = true;
//			for (Map.Entry<String, ThangNam> entry : sortedMapMonth.entrySet()) {
//				if (entry.getKey().equals(thangNamTu)) flag = false;
//				if (!entry.getKey().equals(thangNamTu) && flag) continue;
//					countSize++;
//				if (entry.getKey().equals(thangNamDen)) break;
//			}
//			dsTKKH = new ArrayList[countSize];
...
//				if (entry.getKey().equals(thangNamTu)) flag = false;
//				if (!entry.getKey().equals(thangNamTu) && flag) continue;
//				this.dsTKKH[q] = kh_dao.thongKeKhachTheoThang(entry.getValue().thang, entry.getValue().nam);
//				this.resultsTKMonth[q] = entry.getKey();
//				q++;
//				if (entry.getKey().equals(thangNamDen)) break;
//			}
//			docDuLieuVaoTableTongQuat();
...
//				if (entry.getKey().equals(thangNamTu)) flag = false;
//				if (!entry.getKey().equals(thangNamTu) && flag) continue;
//				this.dsTKKH[q] = kh_dao.thongKeKHMoiTheoThang(entry.getValue().thang, entry.getValue().nam);
//				this.resultsTKMonth[q] = entry.getKey();
//				q++;
//				if (entry.getKey().equals(thangNamDen)) break;
//			}
...
//				if (entry.getKey().equals(thangNamTu)) flag = false;
//				if (!entry.getKey().equals(thangNamTu) && flag) continue;
//				this.dsTKKH[q] = kh_dao.thongKeKHCuTheoThang(entry.getValue().thang, entry.getValue().nam);
//				this.resultsTKMonth[q] = entry.getKey();
//				q++;
//				if (entry.getKey().equals(thangNamDen)) break;
//			}
...
//				if (entry.getKey().equals(thangNamTu)) flag = false;
//				if (!entry.getKey().equals(thangNamTu) && flag) continue;
//				this.dsTKKH[q] = kh_dao.thongKeKHQuenTheoThang(entry.getValue().thang, entry.getValue().nam);
//				this.resultsTKMonth[q] = entry.getKey();
//				q++;
//				if (entry.getKey().equals(thangNamDen)) break;
//			}
...
//				if (entry.getKey().equals(thangNamTu)) flag = false;
//				if (!entry.getKey().equals(thangNamTu) && flag) continue;
//				this.dsTKKH[q] = kh_dao.thongKeKHCoHDNhieuNhatTheoThang(entry.getValue().thang, entry.getValue().nam);
//				this.resultsTKMonth[q] = entry.getKey();
//				q++;
//				if (entry.getKey().equals(thangNamDen)) break;
//			}
...
//				if (entry.getKey().equals(thangNamTu)) flag = false;
//				if (!entry.getKey().equals(thangNamTu) && flag) continue;
//				this.dsTKKH[q] = kh_dao.thongKeKHCoHDItNhatTheoThang(entry.getValue().thang, entry.getValue().nam);
//				this.resultsTKMonth[q] = entry.getKey();
//				q++;
//				if (entry.getKey().equals(thangNamDen)) break;
//			}
...
//	}
//
//	private void thongKeTatCaLoaiPhong(String loai) {
//		if (loai.equals(listLoai[0][1])) {
//			Date ngay = (Date) datePickerTu.getModel().getValue();
//			// Khởi tạo từng phần tử của mảng là một ArrayList
//
//			Map<String, String> lpList = lp_dao.getAllLoaiPhong();
//			dsTKKH = new ArrayList[lpList.size()];
//			for (int i = 0; i < dsTKKH.length; i++) {
//				dsTKKH[i] = new ArrayList<>();
//			}
//
//			int q = 0;
//			for (Map.Entry<String, String> entry : lpList.entrySet()) {
//				String key = entry.getKey();
////				String value = entry.getValue();
//				this.dsTKKH[q] = kh_dao.thongKeKHTheoLoaiPhongTheoNgay(ngay, key);
//				q++;
//			}
//			docDuLieuVaoTableTongQuat();
//		} else if (loai.equals(listLoai[0][2])) {
...
//				String key = entry.getKey();
////				String value = entry.getValue();
//				this.dsTKKH[q] = kh_dao.thongKeKHTheoLoaiPhongTheoThang(mapMonth.get(thangNamTu).thang,
//						mapMonth.get(thangNamTu).nam, key);
//				q++;
//			}
//			docDuLieuVaoTableTongQuat();
//		} else if (loai.equals(listLoai[0][3])) {
...
//				String key = entry.getKey();
////				String value = entry.getValue();
//				this.dsTKKH[q] = kh_dao.thongKeKHTheoLoaiPhongTheoNam(mapYear.get(namTu), key);
//				q++;
//			}
//			docDuLieuVaoTableTongQuat();
//		}
//	}
//
//	private void thongKeLoaiPhongNhieuNhat(String loai) {
//		if (loai.equals(listLoai[0][1])) {
//
//		} else if (loai.equals(listLoai[0][2])) {
//
...
//	}
//
//	private void thongKeLoaiPhongItNhat(String loai) {
//		if (loai.equals(listLoai[0][1])) {
//
//		} else if (loai.equals(listLoai[0][2])) {
//
...
//	}
//
//	private void thongKeTatCaDichVu(String loai) {
//		if (loai.equals(listLoai[0][1])) {
//			Date ngay = (Date) datePickerTu.getModel().getValue();
//			// Khởi tạo từng phần tử của mảng là một ArrayList
//
//			Map<String, String> dvList = new HashMap<>();
//			dvList = dv_dao.getAllDichVu();
//
//			dsTKKH = new ArrayList[dvList.size()];
...
//
//			int q = 0;
//			for (Map.Entry<String, String> entry : dvList.entrySet()) {
//				String key = entry.getKey();
////				String value = entry.getValue();
//				this.dsTKKH[q] = kh_dao.thongKeKHTheoDichVuTheoNgay(ngay, key);
//				q++;
//			}
//			docDuLieuVaoTableTongQuat();
//		} else if (loai.equals(listLoai[0][2])) {
...
//				String key = entry.getKey();
////				String value = entry.getValue();
//				this.dsTKKH[q] = kh_dao.thongKeKHTheoDichVuTheoThang(mapMonth.get(thangNamTu).thang,
//						mapMonth.get(thangNamTu).nam, key);
//				q++;
//			}
//			docDuLieuVaoTableTongQuat();
...
//				String key = entry.getKey();
////				String value = entry.getValue();
//				this.dsTKKH[q] = kh_dao.thongKeKHTheoDichVuTheoNam(mapYear.get(namTu), key);
//
//				q++;
//			}
//			docDuLieuVaoTableTongQuat();
...
//	}
//
//	private void thongKeDichVuNhieuNhat(String loai) {
//		if (loai.equals(listLoai[0][1])) {
//
//		} else if (loai.equals(listLoai[0][2])) {
//
...
//	}
//
//	private void thongKeDichVuItNhat(String loai) {
//		if (loai.equals(listLoai[0][1])) {
//
//		} else if (loai.equals(listLoai[0][2])) {
//
...
//				} else if (tieuChiDaChon.equals(listTieuChi[1][1])) {
//					thongKeTatCaLoaiPhong(loaiDaChon);
//				} else if (tieuChiDaChon.equals(listTieuChi[1][2])) {
//					thongKeLoaiPhongNhieuNhat(loaiDaChon);
//				} else if (tieuChiDaChon.equals(listTieuChi[1][3])) {
//					thongKeLoaiPhongItNhat(loaiDaChon);
//				} else if (tieuChiDaChon.equals(listTieuChi[2][1])) {
//					thongKeTatCaDichVu(loaiDaChon);
//				} else if (tieuChiDaChon.equals(listTieuChi[2][2])) {
//					thongKeDichVuNhieuNhat(loaiDaChon);
//				} else if (tieuChiDaChon.equals(listTieuChi[2][3])) {
//					thongKeDichVuItNhat(loaiDaChon);
//				}
//			}
//
//		}
...
//				if (mapMonth.get(thangDen).nam < mapMonth.get(thangTu).nam) {
//					JOptionPane.showMessageDialog(this, "Vui lòng chọn tháng/năm lớn hơn hoặc bằng " + thangTu);
//					return false;
//				} else if (mapMonth.get(thangDen).nam == mapMonth.get(thangTu).nam) {
//					if (mapMonth.get(thangDen).thang < mapMonth.get(thangTu).thang) {
//						JOptionPane.showMessageDialog(this, "Vui lòng chọn tháng/năm lớn hơn hoặc bằng " + thangTu);
//						return false;
//					}
//				} else if (mapMonth.get(thangDen).nam > mapMonth.get(thangTu).nam) {
...
//
//			// Loại Phòng
//			for (int j = 1; j < listTieuChi[1].length; j++) {
//				if (tieuChi == listTieuChi[1][j]) {
//					Map<String, String> lpList = lp_dao.getAllLoaiPhong();
//					int i = 0;
//					for (Map.Entry<String, String> entry : lpList.entrySet()) {
////						    String key = entry.getKey();
//						String value = entry.getValue();
//						String time = (tongTieuChi[i] / 60) + " giờ " + (tongTieuChi[i] % 60) + " phút";
//						modeltbTK.addRow(new Object[] { value, this.dsTKKH[i].size(), time });
//						i++;
//					}
//					return;
//				}
...
//
//			// Dịch Vụ
//			for (int j = 1; j < listTieuChi[2].length; j++) {
//				if (tieuChi == listTieuChi[2][j]) {
//					Map<String, String> lpList = dv_dao.getAllDichVu();
//					int i = 0;
//					for (Map.Entry<String, String> entry : lpList.entrySet()) {
////						    String key = entry.getKey();
//						String value = entry.getValue();
//						modeltbTK.addRow(new Object[] { value, this.dsTKKH[i].size(), tongTieuChi[i] });
//						i++;
//					}
//					return;
//				}
...
//			for (int j = 1; j < listTieuChi[2].length; j++) {
//				if (tieuChi == listTieuChi[2][j]) {
//					Map<String, String> lpList = new HashMap<>();
//					lpList = dv_dao.getAllDichVu();
//					int i = 0;
//					for (Map.Entry<String, String> entry : lpList.entrySet()) {
////						    String key = entry.getKey();
//						String value = entry.getValue();
...
//							kh.getMaKH(), kh.getTenKH(), kh.isGioiTinh() ? "Nam" : "Nữ",
//							dateFormat.format(kh.getNgaySinh()), kh.getSoDienThoai(), kh.getCccd(), kh.getDiaChi() });
//				}
//			}
//		}
//
...
//					kh = this.dsTKKH[selectedRow].get(i).getKhachHang();
//					SimpleDateFormat dateFormat = new SimpleDateFormat("dd/MM/YYYY");
//					String time = (this.dsTKKH[selectedRow].get(i).getTongTheoTieuChi() / 60) + " giờ "
//							+ (this.dsTKKH[selectedRow].get(i).getTongTheoTieuChi() % 60) + " phút";
//					modelTKChiTiet.addRow(new Object[] { time, kh.getMaKH(), kh.getTenKH(),
//							kh.isGioiTinh() ? "Nam" : "Nữ", dateFormat.format(kh.getNgaySinh()), kh.getSoDienThoai(),
//							kh.getCccd(), kh.getDiaChi() });
//				}
//			}
//		}
//
