...
public class PnGiaoDienThongKeDoanhThu extends JPanel implements ActionListener {
...
//	 */
//	public PnGiaoDienThongKeDoanhThu() {
...
//		modelTKChiTiet.addColumn("Mã NV"); // 2
//		modelTKChiTiet.addColumn("Tên khách hàng"); // 3
//		modelTKChiTiet.addColumn("Tên nhân viên"); // 4
//		modelTKChiTiet.addColumn("Mã KH"); // 5
//		modelTKChiTiet.addColumn("Ngày lập hóa đơn"); // 6
//		modelTKChiTiet.addColumn("Thời gian trả phòng"); // 7
//		modelTKChiTiet.addColumn("Mã KM"); // 8
//		
...
//		tblTKChiTiet.getColumnModel().getColumn(2).setPreferredWidth(80); // Mã nhân viên
//		tblTKChiTiet.getColumnModel().getColumn(3).setPreferredWidth(150); // Tên khách hàng
//		tblTKChiTiet.getColumnModel().getColumn(4).setPreferredWidth(150); // Tên nhân viên
//		tblTKChiTiet.getColumnModel().getColumn(5).setPreferredWidth(80); // Mã khách hàng
//		tblTKChiTiet.getColumnModel().getColumn(6).setPreferredWidth(150); // Ngày lập hóa đơn
//		tblTKChiTiet.getColumnModel().getColumn(7).setPreferredWidth(150); // Thời gian trả phòng
//		// mã khuyến mãi
//		
//		// sort
...
//			modelTKChiTiet.addRow(new Object[] {formatCurrency(this.dsTKHD.get(i).getTongTienPhong() + this.dsTKHD.get(i).getTongTienDV()),hd.getMaHoaDon(), hd.getNv().getMaNV(), hd.getTenKH(), hd.getTenNV(), hd.getKh().getMaKH(), hd.getNgayLapHD(), hd.getThoiGianTraPhong(),hd.getKm().getMaKM()});
//		}
//	}
}
